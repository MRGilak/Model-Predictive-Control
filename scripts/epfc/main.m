...
results = simulate_closed_loop(method, Ts, tf, N_model, mu, m, q, r, psi, ...
...
plot_simulation_results(results.time, results.Y, Ref, ...
                        ...
                        results.X, u_min, u_max, dist_time, dist_amp, tf);
